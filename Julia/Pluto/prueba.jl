...
# ╔═╡ a8e4c476-03b9-11ec-32cc-6d5e78d8baa4
using Parquet, CSV, ZipFile, DataFrames

# ╔═╡ 36e7f571-72e5-4e16-be4d-88c60a97787b
import Downloads

# ╔═╡ 491e1f3e-e0bc-4861-9047-976459e87864
path = Downloads.download("http://datosabiertos.salud.gob.mx/gobmx/salud/datos_abiertos/datos_abiertos_covid19.zip", "covid19.zip")

# ╔═╡ b06f18b1-7534-4355-93aa-d572ffb84762
z = ZipFile.Reader(path)

# ╔═╡ f7498e9d-0285-4a68-8891-6d2c1dec748c
z.files[1] |> CSV.File
...
git-tree-sha1 = "1741bd68c3d4b4b397391d6d3d16bc100b267003"
uuid = "8d9c9c80-f77e-5080-9541-c6f69d204e22"
version = "0.8.0"

[[ThriftJuliaCompiler_jll]]
deps = ["Artifacts", "JLLWrappers", "Libdl", "Pkg"]
git-tree-sha1 = "7ecfd6e1d52c8ad58443a1facf2a2ab691cc7355"
